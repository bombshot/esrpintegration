...
import * as GatewayClient from '../Ms.Ess.Release.Task.Common/api'
import { AuthenticationManager } from './authContextManager';
import { IAuthenticationManager } from './iAuthContextManager';
import delay from 'delay';
import { IMessageCreator } from '../Ms.Ess.Release.Task.Common/iMessageCreator';
import { MessageCreator } from '../Ms.Ess.Release.Task.Common/messageCreator';
